...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    appName: "Farming AI GPT",
    appSubtitle: "Farming AI Assistant",
    newChat: "New Chat",
    ...
    language: "Language",
    inputPlaceholder: "Ask Farming AI Assistant any farming question...",
    ...
    diagnosticReport: "Farming AI GPT Diagnostic Summary",
    cropName: "Crop Name",
    ...
    medium: "Medium 🟡",
    low: "Low 🟢",
    welcomeTitle: "Jai Kisaan! 🌾",
    welcomeSubtitle: "Main hoon aapka Farming AI Assistant. Farming AI GPT mein aapka swagat hai! Aap mujhse fasal, khaad, mausam, keeṭ, ya kisi bhi kheti se judi baat pooch sakte hain. Batayein, aaj main aapki kya madad kar sakta hoon? 😊",
    ...
    handsFreeMode: "Hands-Free (Auto-Send) 🌾",
    notFarmingRefusal: "Arey भैया/वीर जी, मैं केवल खेती-बाड़ी and किसान भाइयों की मदद करने वाली Farming AI GPT की सहेली सहायक हूँ। खेती का कुछ भी पूछो, मैं तुरंत उत्तर दूँगी! 😊",
  ...
  hi: {
    appName: "Farming AI GPT",
    appSubtitle: "फ़ार्मिंग एआई असिस्टेंट",
    ...
    language: "भाषा",
    inputPlaceholder: "अपनी प्यारी एआई सहेली से खेती का कोई भी सवाल पूछें...",
    ...
    diagnosticReport: "Farming AI GPT रोग निदान रिपोर्ट",
    cropName: "फसल का नाम",
    ...
    medium: "मध्यम गंभीर 🟡",
    low: "सामान्य स्थिति 🟢",
    welcomeTitle: "जय किसान! 🌾",
    welcomeSubtitle: "मैं हूँ आपकी प्यारी फ़ार्मिंग एआई असिस्टेंट। Farming AI GPT में आपका बहुत-बहुत स्वागत है! आप मुझसे फसल, खाद, मौसम, कीट या किसी भी खेती और पशुपालन से जुड़ी बातें पूछ सकते हैं। बताएं, आज मैं आपकी क्या मदद कर सकती हूँ? 😊",
    cardDiseaseTitle: "पत्तियों का रोग निदान",
    cardDiseaseDesc: "पत्ती की फोटो अपलोड या कैप्चर करें। एआई फंगल बिलाइट, ख़ैरा, पोषक तत्वों की कमी या कीड़ों का पता लगाएगा।",
    cardFertTab: "खाद की सही खुराक",
    cardFertDesc: "पूछें कि मिट्टी के प्रकार के आधार पर प्रति एकड़ कितना यूरिया, डीएपी या जिंक डालने की आवश्यकता है।",
    cardMandiTab: "मंडी दर खोजें",
    cardMandiDesc: "खन्ना, करनाल, बठिंडा और अमृतसर की मंडियों में अनाज के वास्तविक समय के भाव जानें।",
    voiceActive: "किसान भाई बोलिए, हम सुन रहे हैं...",
    handsFreeMode: "ऑटो-भेजें (Hands-Free) 🌾",
    notFarmingRefusal: "अरे भैया/वीर जी, मैं केवल खेती-बाड़ी और किसान भाइयों की मदद करने वाली Farming AI GPT की सहेली सहायक हूँ। खेती का कुछ भी पूछो, मैं तुरंत उत्तर दूँगी! 😊",
    history: "निरीक्षण चैट इतिहास",
    noHistory: "कोई पिछला चैट इतिहास नहीं है। एक नया फसल निरीक्षण प्रारंभ करें!",
    speakText: "आवाज़ में सुनें",
    calculating: "गणना की जा रही है...",
    acreageInput: "फार्म क्षेत्र (एकड़) दर्ज करें",
    selectCrop: "फसल चुनें",
    calcUrea: "यूरिया खाद",
    calcDap: "डीएपी (DAP)",
    calcMop: "पोटाश (MOP)",
    calcBags: "आवश्यक मात्रा (50 किलोग्राम की बोरियां)",
    weatherHot: "मौसम काफी शुष्क और गर्म है। फसलों में नमी बनाये रखने के लिए सिंचाई करें।",
    weatherRain: "हल्की बारिश की संभावना है। दवाओं या कीटनाशकों का छिड़काव अभी रोकें।",
    weatherMild: "अनुकूल मौसम है। यूरिया के छिड़काव के लिए बहुत उत्तम समय है।",
    searchMarket: "फसल या मंडी का नाम खोजें..."
  },
  pa: {
    appName: "Farming AI GPT",
    appSubtitle: "ਫਾਰਮਿੰਗ ਏਆਈ ਅਸਿਸਟੈਂਟ",
    ...
    language: "ਭਾਸ਼ਾ",
    inputPlaceholder: "ਆਪਣੀ ਫਾਰਮਿੰਗ ਏਆਈ ਸਹੇਲੀ ਤੋਂ ਖੇਤੀਬਾੜੀ ਸਵਾਲ ਪੁੱਛੋ...",
    ...
    diagnosticReport: "Farming AI GPT ਬਿਮਾਰੀ ਰਿਪੋਰਟ",
    cropName: "ਫਸਲ ਦਾ ਨਾਮ",
    ...
    medium: "ਦਰਮਿਆਨਾ 🟡",
    low: "ਸਧਾਰਨ ਸਥਿਤੀ 🟢",
    welcomeTitle: "ਜੈ ਕਿਸਾਨ! 🌾",
    welcomeSubtitle: "ਮੈਂ ਹਾਂ ਤੁਹਾਡੀ ਪਿਆਰੀ ਫਾਰਮਿੰਗ ਏਆਈ ਅਸਿਸਟੈਂਟ। Farming AI GPT ਵਿੱਚ ਤੁਹਾਡਾ ਬਹੁਤ-ਬਹੁਤ ਸੁਆਗਤ ਹੈ! ਤੁਸੀਂ ਮੈਥੋਂ ਫਸਲ, ਖਾਦ, ਮੌਸਮ, ਕੀੜੇ ਜਾਂ ਕਿਸੇ ਵੀ ਖੇਤੀ ਅਤੇ ਪਸ਼ੂਪਾਲਣ ਬਾਰੇ ਪੁੱਛ ਸਕਦੇ ਹੋ। ਦੱਸੋ, ਅੱਜ ਆਪਣੀ ਇਸ ਸਹੇਲੀ ਤੋਂ ਕੀ ਪੁੱਛਣਾ ਚਾਹੁੰਦੇ ਹੋ? 😊",
    cardDiseaseTitle: "ਪੱਤਿਆਂ ਦੀ ਬੀਮਾਰੀ ਜਾਂਚ",
    cardDiseaseDesc: "ਪੱਤੇ ਦੀ ਫੋਟੋ ਖਿੱਚੋ ਜਾਂ ਅਪਲੋਡ ਕਰੋ। ਫਾਰਮਿੰਗ ਏਆਈ ਅਸਿਸਟੈਂਟ ਉੱਲੀ, ਪੀਲਾ ਰਸਟ, ਕੀੜੇ ਜਾਂ ਖੁਰਾਕੀ ਤੱਤਾਂ ਦੀ ਕਮੀ ਦੱਸੇਗਾ।",
    ...
    cardMandiDesc: "ਲਿੰਕ ਅਤੇ ਅਨਾਜ ਮੰਡੀਆਂ ਦੇ ਅੱਜ ਦੇ ਰੇਟ ਦੇਖੋ Punjab ਅਤੇ Haryana ਦੀਆਂ ਮੁੱਖ ਮੰਡੀਆਂ ਵਿੱਚ।",
    voiceActive: "ਕਿਸਾਨ ਵੀਰ ਜੀ ਬੋਲੋ, ਅਸੀਂ ਸੁਣ ਰਹੇ ਹਾਂ...",
    handsFreeMode: "ਆਟੋ-ਭੇਜੋ (Hands-Free) 🌾",
    notFarmingRefusal: "ਅਰੇ ਵੀਰ ਜੀ, ਮੈਂ ਸਿਰਫ਼ ਖੇਤੀਬਾੜੀ ਅਤੇ ਕਿਸਾਨ ਵੀਰਾਂ ਦੀ ਮਦਦ ਕਰਨ ਵਾਲੀ Farming AI GPT ਦੀ ਸਹੇਲੀ ਸਹਾਇਕ ਹਾਂ। ਖੇਤੀ ਬਾਰੇ ਕੁਝ ਵੀ ਪੁੱਛੋ, ਮੈਂ ਤੁਰੰਤ ਜਵਾਬ ਦੇਵਾਂਗੀ! 😊",
    ...
    weatherRain: "ਹਲਕੇ ਮੀਂਹ ਦੀ ਸੰਭਾਵਨਾ ਹੈ। ਦਵਾਈਆਂ ਦਾ ਛਿੜਕਾਅ ਹਾਲੇ ਰੋਕ ਦਿਓ।",
...
export const MOCK_MANDI_PRICES: MandiPrice[] = [
  ...
  { id: '5', crop: { en: 'Paddy (Basmati 1121)', hi: 'धान (बासमती 1121)', pa: 'ਬਾਸਮਤੀ 1121' }, market: { en: 'Amritsar Vallah', hi: 'अमृतसर वल्ला मंडी', pa: 'ਅਮ੍ਰਿਤਸਰ' }, price: 4250, change: 'up', changeAmount: 75 },
  ...
  { id: '8', crop: { en: 'Mustard (Sarson)', pa: 'ਸਰੋਂ', hi: 'सरसों' }, market: { en: 'Bathinda Market', hi: 'बठिंडा मंडी', pa: 'ਬਠਿੰਡਾ' }, price: 5420, change: 'stable', changeAmount: 0 },
